...
class Auth with ChangeNotifier {
  ...
  void signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBYb9I1ChX6fr3pCV00253EgzUS2MmLQg8");
    try {
  ...
  void signin(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBYb9I1ChX6fr3pCV00253EgzUS2MmLQg8");
    try {
      var response = await http.post(
        url,
        body: json.encode({
